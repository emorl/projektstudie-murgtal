...
# gesuchter Datensatznt/display/CKB/How+to+install+and+use+CDS+API+on+Windows
client = cdsapi.Client()
dataset = "derived-era5-single-levels-daily-statistics"

# Definition des Daten-requests, kopiert vom Downloadportal des CDS 
request = {  
